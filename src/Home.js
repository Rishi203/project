           ...
           <div className="py-5 px-20 ">
                <nav class="bg-black p-4 rounded-xl h-20">
                    <div class="container mx-auto flex">
                        <div class="text-[#ADFF45] text-4xl font-extrabold px-6 ml-28 mr-10">URBAN LINK</div>
                        <div>
                        ...
                        <div className="lgbutton flex ml-auto mr-10 space-x-5">
                            <button onClick={handleClick} className="bg-[#ADFF45] px-8 rounded-xl text-lg hover:bg-[#aeff45ed]">
                                Login
                            </button>

                            <button onClick={handleClick1} className="bg-[#EEFFF0] px-8 rounded-xl text-lg hover:bg-[#ADFF45]">
                                Signup
                            </button>
            ...
            <div className="flex mt-40">
                <div className="w-1/2 ml-28 mb-20">
                    <h className="text-6xl font-inter font-semibold">RIDE SEARCH</h>
                    ...
                    <div class="flex flex-col gap-6 max-w-sm ml-3 p-4 bg-[#EEFFF0] mt-12 rounded-xl ">
                        ...
                        />
                        <button
                            className="bg-black hover:bg-gray-800 text-white font-bold py-2 rounded-xl"
                        >
                            Search
                        </button>
                    </div>
                ...
                <div className="w-1/2 mx-auto my-40">
                    <p className="text-3xl mr-44 font-semibold font-inter text-center">Your Ride Is Just A Search Away! Enter Your Destination To Find Available Rides And Start Your Journey Hassle Free</p>
