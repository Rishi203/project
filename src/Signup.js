          ...
          <form onSubmit={handleSubmit}>
            <div className="inputbox flex flex-col mx-28">
              ...
              <button className="flex flex-row text-base rounded-lg bg-[#CAFF87] text-black border border-black px-24 py-3 my-2 font-semibold hover:bg-[#D5FFA1]">
                <span><img className="h-7 w-7 rounded-full mx-2" src="https://pbs.twimg.com/profile_images/1605297940242669568/q8-vPggS_400x400.jpg" alt="google"></img></span>
          ...
          {showPopup && (
            <div className="fixed inset-0 flex items-center justify-center z-10">
              <div className="bg-white p-6 rounded shadow-lg">
                ...
                <button className="mt-4 bg-black text-white py-2 px-4 rounded" onClick={closePopup}>
                  Close
                </button>
              </div>
            </div>
